...
def move_object(speed, move_distance, object_name):
    ...
    directions = [
        ...
        (-move_distance/2, 3.0),   # Move along +Y-axis
        (-move_distance/2, -3.0),  # Move along -X-axis
    ]
...
if __name__ == '__main__':
    rospy.init_node('move_object_t', anonymous=True)
    try:
        # Randomize speed and define parameters
        MIN_SPEED = 0.2
        MAX_SPEED = 0.6
        MOVE_DISTANCE = 3.46
        OBJECT_NAME = "sphere"  # Replace with your Gazebo model name
